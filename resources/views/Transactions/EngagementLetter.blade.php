                ...
                <table class="table table-bordered" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td style="width: 50%" class="text-right">
                            ...
                            <h5>
                                ...
                                مكـتب علي عبدالله البخيت للمحاسبة والمراجعة لأي سبب   يتعـــلق بالخدمــات موضوع   هذا الخطاب لا تتجاوز باى حال من الأحوال قيمة الأتعاب المدفوعة للمكتب. عن الخدمات أو المنتج المسبب.
                            </h5>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <h5 class="text-right">
                                إن هذا الخطاب يُمثّل كامل الإتفاقية فيما بين الشركة ومكـتب علي عبدالله البخيت للمحاسبة. فيما يتعلق بالخدمات المشار إليها في هذا الخطاب. هذا الخطاب يلغي أية عروض أو مراسلات أو إتفاقيات تفاهم سابقة سواءً كانت خطّية أو شفهية تخص العمل موضوع هذا الخطاب. إن الإتفاقيات القائمة بين الشركة أو المكتب والمتضمنة في هذا الخطاب سوف تظل سارية حتى إكمال أو إنهاء الأمور موضوع هذا الخطاب.
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <h5 class="text-right">
                                ...
                                عن مكتب علي عبدالله البخيت للمحاسبة والمراجعة
                                علي عبد الله البخيت
                            </h5>
                    ...
                    <tr>
                        ...
                        <td>
                            <h4 class="text-right">
                                نأمل إيداع الأتعاب أو تحويلها على حساب المكتب بمصرف الراجحي حساب رقم (211608010988900) أو شيك باسم مكتب علي عبدالله آل بخيت الزهراني للمحاسبة والمراجعة.
                            </h4>
                        </td>
                    </tr>
                    <!--- /. Eleventh Row--->
